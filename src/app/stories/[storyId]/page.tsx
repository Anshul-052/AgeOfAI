...
export default async function StoryPage({ params }: { params: Promise<{ storyId: string }> }) {
  ...
  return <main className="publication-main article-main"><Link className="eyebrow" href="/search">The story archive</Link><StoryCard story={story} isLead fullArticle />
